...
# Open video file
cap = cv2.VideoCapture("../Videos/f3.mp4")
...
def detect_temperature(frame):
    ...
    for temp_label, (lower, upper) in temperature_map.items():
        ...
        for contour in contours:
            ...
            min_area = 50 if temp_label in ["900C", "1000C", "1200C"] else 1200
            ...
            if area > min_area:
                ...
                all_confidences.append(area)
                all_labels.append(temp_label)

    if len(all_boxes) > 0:
        indices = cv2.dnn.NMSBoxes(all_boxes, all_confidences, score_threshold=0.3, nms_threshold=0.5)
        ...
        if len(indices) > 0:
            ...
            for i in indices.flatten():
                ...
                overlap = False
                for xb, yb, wb, hb in filtered_boxes:
                ...
                if not overlap:
                    ...
                    box_color = (0, 0, 255) if temp_label == "1200C" else (0, 255, 0)
